    ...
    try {
      ...
      if (mode === "edit") {
        ...
        if (response.meta?.requestStatus === "fulfilled") {
          toast.success(
            response.payload?.message || "Broker updated successfully",
          );
        ...
        if (response.meta?.requestStatus === "fulfilled") {
          toast.success(
            response.payload?.message || "Broker added successfully",
          );
          ...
          <div className="broker-modal-footer">
            {step === 1 ? (
              ...
              <>
                ...
                <button
                  className="broker-modal-btn broker-modal-btn--primary broker-btn-accent"
