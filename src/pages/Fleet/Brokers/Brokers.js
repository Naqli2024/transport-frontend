...
const Brokers = () => {
  ...
  const { brokers, brokerDetails, summary, loading, error } = useSelector(
    (state) => state.broker,
  );
  ...
  const handleDelete = async () => {
    if (!selectedBroker?._id || deleteLoading) return;
    ...
    try {
      ...
      toast.error(
        error?.message || "Something went wrong while deleting broker",
      );
    } finally {
          ...
          <div className="vm-delete-modal">
            ...
            <div className="vm-delete-actions">
              ...
              >
                {deleteLoading ? (
                  <>
                    <span className="broker-btn-loader" />
                    Deleting...
                  </>
                ) : (
                  <>
