...
import { addCustomer, editCustomer, getAllCustomers, getCustomerDashboard } from "../../../redux/Customer/CustomerSlice";
...
const Field = ({ label, required, children, full }) => (
    <div className={`customer-modal-field${full ? " customer-modal-field--full" : ""}`}>
                ...
                >
                    ...
                    <div className="customer-modal-header">
                        <div className="customer-modal-title">
                            <PersonIcon />
                            {mode === "edit" ? "Edit Customer" : "Add Customer"} — Step {step}/2
                        </div>
